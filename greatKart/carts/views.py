    ...
    if current_user.is_authenticated:
        ...
        if is_cart_item_exist:
            ...
            if product_variation in exist_variation_list: #if the current variation for the certain product exist already
                ...
                item = CartItem.objects.create(product=product, quantity=1, user=current_user) # if the product_variation variation doesnotexist already we will create a new one with quantity 1            
